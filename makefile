...
build:
	@echo "==> building..."
	go build -ldflags "-X github.com/katbyte/gogo-azurerm-info/lib/version.GitCommit=${GIT_COMMIT}"
...
install:
	@echo "==> installing..."
	go install -ldflags "-X github.com/katbyte/gogo-azurerm-info/lib/version.GitCommit=${GIT_COMMIT}" .
